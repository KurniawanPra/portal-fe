...
export default function LoginPage() {
  ...
  const initAudioEnhancer = () => {
    ...
    try {
      ...
      // Web Audio enhancer is optional — ignore if unsupported/blocked.
    }
  };
  ...
  return (
    <div className="relative min-h-screen lg:h-screen w-full bg-[#f8fafc] dark:bg-[#0b0f17] lg:overflow-hidden transition-colors duration-300">
      ...
      {/* Foreground */}
      <div className="relative z-20 flex h-[100svh] lg:h-full w-full flex-col lg:flex-row justify-between">
        {/* Left Side: Login Form (Flex layout to prevent overlapping) */}
        <div className={cn(
          'w-full lg:w-[45%] h-[100svh] lg:h-screen flex flex-col justify-between py-6 px-4 sm:p-8 md:p-10 lg:py-8 z-20 relative overflow-y-auto overflow-x-hidden lg:overflow-hidden no-scrollbar',
          ...
          <div className="login-card-container w-full flex-1 flex flex-col items-center justify-start sm:justify-center pt-12 sm:pt-0 py-6 sm:py-8 mt-0 sm:-mt-10 animate-ios-page max-w-md mx-auto">
            <LoginCard />
          </div>
