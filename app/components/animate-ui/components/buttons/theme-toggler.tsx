...
export function ThemeTogglerButton({
  ...
  const variantClasses = {
    outline: 'border border-white/80 dark:border-white/[0.08] bg-[#e6ecf4]/80 dark:bg-[#0b0e15]/80 shadow-[inset_2px_2px_5px_rgba(163,177,198,0.5),inset_-2px_-2px_5px_rgba(255,255,255,0.95)] dark:shadow-[inset_3px_3px_8px_rgba(4,7,13,0.75),inset_-2px_-2px_6px_rgba(35,46,68,0.35)] backdrop-blur-md',
    ghost: 'bg-transparent',
    solid: 'bg-[#e6ecf4] dark:bg-[#0b0e15] shadow-[inset_2px_2px_5px_rgba(163,177,198,0.5)]',
    pill: 'rounded-full border border-white/80 dark:border-white/[0.08] bg-[#e6ecf4]/80 dark:bg-[#0b0e15]/80 shadow-[inset_2px_2px_5px_rgba(163,177,198,0.5),inset_-2px_-2px_5px_rgba(255,255,255,0.95)] dark:shadow-[inset_3px_3px_8px_rgba(4,7,13,0.75),inset_-2px_-2px_6px_rgba(35,46,68,0.35)] backdrop-blur-md',
  }[variant];
  ...
  return (
    ...
    >
      ...
      {activeIndex !== -1 && (
        <div
          className={`absolute bg-white dark:bg-[#161d2a] shadow-[3px_3px_8px_rgba(163,177,198,0.5),-2px_-2px_6px_rgba(255,255,255,1)] dark:shadow-[3px_3px_8px_rgba(4,7,13,0.85),-2px_-2px_6px_rgba(35,46,68,0.4)] border border-white/80 dark:border-white/[0.08] transition-all duration-300 ease-[cubic-bezier(0.25,1,0.5,1)] ${pillRounding}`}
          style={
            direction === 'horizontal'
              ? {
                  left: '4px',
