...
export default function TabPenempatanArea() {
  ...
  const handleMapSelect = (lat: number | string, lng: number | string) => {
      ...
      <ModalPortal open={!!previewTarget}>
        ...
        <div className="absolute inset-0 flex items-center justify-center p-4 pointer-events-none z-[70]">
          <div className="pointer-events-auto w-full max-w-xl animate-fade-up">
            <div className="relative overflow-hidden rounded-xl border border-slate-300 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xl shadow-slate-900/10">
              {/* Header */}
              ...
              {/* Footer */}
              <div className="flex items-center justify-between border-t border-slate-300 dark:border-white/[0.06] px-5 py-3.5 bg-slate-50/50 dark:bg-slate-950/30">
                {previewTarget && (
                  <a
